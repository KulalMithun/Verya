...
// Redirect to OpenWES dashboard or base url
const baseUrl = getBaseUrl();
const pathname = window.location.pathname;

if (pathname === '/' || pathname === '' || pathname === `/${baseUrl}` || pathname === `/${baseUrl}/`) {
  window.location.replace(`/${baseUrl}/openwes/dashboard`);
} else if (
  ...
  // Automatically prepend baseUrl (e.g. /openwes/dashboard -> /web/openwes/dashboard)
  window.location.replace(
    `/${baseUrl}${pathname}${window.location.search}${window.location.hash}`
  );
}
