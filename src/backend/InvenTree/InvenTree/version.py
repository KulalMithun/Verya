...
def inventreeInstanceName() -> str:
    ...
    return get_global_setting('INVENTREE_INSTANCE', default='Veyra') or 'Veyra'
...
def inventreeDocUrl() -> str:
    """Return URL for documentation site."""
    return '/api-doc/'


def inventreeAppUrl() -> str:
    """Return URL for app site."""
    return '/'


def inventreeGithubUrl() -> str:
    """Return URL for repository site."""
    return ''
